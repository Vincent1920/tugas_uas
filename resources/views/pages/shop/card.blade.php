    ...
    <nav class="navbar">
        ...
        <ul class="navbar1">
            ...
            <li class="navbar-li dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li class="dropdown-item">
                        <a class="navbar-link1" href="../page/shop.html">
                            <div class="navbar-img1">
        ...
        <ul>
            <li id="dd2" class="navbar_cart wrapper-dropdown-3 navbar-li navbar_cart navbar-link">
                ...
                <ul class="dropdown">
                    ...
                    @else
                    <li class="bob_nav"><a class="dropdown_a" href="#">Card
        ...
        <div class="container1">
            <div id="main">
                <div class="container0-1">
                    <img id="image" src="{{ asset('images/' . $barang->img) }}" alt="{{ $barang->title }}" class="img-fluid">
                ...
                <div id="container">
                    <div id="title">
                        ...
                        <p>{{$barang->title}}</p>
                        {{-- {{ $barang->title }} --}}
                        <!-- <div id="sub-title">Taste the essence of real tangerine</div> -->
                    </div>
                    <div id="btnn">
                        <button class="btnn btnt-background-slide">Background Slide</button></div>
                </div>
            </div>
        </div>
